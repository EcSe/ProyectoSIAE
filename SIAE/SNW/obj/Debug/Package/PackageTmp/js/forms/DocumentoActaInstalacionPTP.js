$(document).ready(function () {
    ...
    $('#cphContenido_txtNivelRecepcionOperacionRadioA').number(true, 0);
    ...
    $('#cphContenido_txtNivelRecepcionOperacionRadioB').number(true, 0);
    ...
    $('#cphContenido_txtPingPTPRadioA').number(true, 0);
    ...
    $('#cphContenido_txtPingPTPRadioB').number(true, 0);
    ...
    $('#cphContenido_txtB_A').number(true, 0);
    ...
    $('#cphContenido_txtC_A').number(true, 0);
    ...
    $('#cphContenido_txtD_A').number(true, 0);
    ...
    $('#cphContenido_txtE_A').number(true, 0);
    ...
    $('#cphContenido_txtB_B').number(true, 0);
    ...
    $('#cphContenido_txtC_B').number(true, 0);
    ...
    $('#cphContenido_txtD_B').number(true, 0);
    ...
    $('#cphContenido_txtE_B').number(true, 0);
    ...
    $('#cphContenido_txtCapacidadBreakerEstacionA').number(true, 0);
    ...
    $('#cphContenido_txtVoltajeCDBreakerEstacionA').number(true, 0);
    ...
    $('#cphContenido_txtPosicionBreakerEstacionA').number(true, 0);
    ...
    $('#cphContenido_txtCapacidadBreakerEstacionB').number(true, 0);
    ...
    $('#cphContenido_txtVoltajeCDBreakerEstacionB').number(true, 0);
    ...
    $('#cphContenido_txtPosicionBreakerEstacionB').number(true, 0);
