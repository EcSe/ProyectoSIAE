    ...
    public partial class DocumentoActaInstalacionPTP : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (Request.QueryString["IdTarea"] != null && Request.QueryString["IdDocumento"] != null)
                {
                    ...
                    #region Resultados de Analisis Estación A 01 (Ejemplo)
                    UtilitarioBL.AsignarEntidadDetalleImagen(entidadDetalleBE, "CAMP_EJE", "000389",
                        imgResultadosAnalisisEstacionA01Ejemplo);
                    #endregion

                    #region Resultados de Analisis Estación A 02 (Ejemplo)
                    UtilitarioBL.AsignarEntidadDetalleImagen(entidadDetalleBE, "CAMP_EJE", "000390",
                        imgResultadosAnalisisEstacionA02Ejemplo);
                    #endregion

                    #region Resultados de Analisis Estación B 01 (Ejemplo)
                    UtilitarioBL.AsignarEntidadDetalleImagen(entidadDetalleBE, "CAMP_EJE", "000391",
                        imgResultadosAnalisisEstacionB01Ejemplo);
                    #endregion

                    #region Resultados de Analisis Estación B 02 (Ejemplo)
                    UtilitarioBL.AsignarEntidadDetalleImagen(entidadDetalleBE, "CAMP_EJE", "000392",
                        imgResultadosAnalisisEstacionB02Ejemplo);
                    #endregion
                    ...
                    if (lstDetalles.Count > 0)
                    {
                        ...
                        DocumentoDetalle = lstDetalles.Where(dd => dd.Campo.IdValor == "000501").Select(dd => dd).First();
                        UtilitarioBL.ObtenerDocumentoDetalle(DocumentoDetalle,
                            chkResultadosAnalisisEstacionA01,
                            hfResultadosAnalisisEstacionA01Comentario, null, null,
                            hfResultadosAnalisisEstacionA01, strRutaFisicaTemporal,
                            Type.GetType("System.Byte[]"));
                        #endregion

                        #region Resultados de Analisis Estación A 02
                        DocumentoDetalle = lstDetalles.Where(dd => dd.Campo.IdValor == "000502").Select(dd => dd).First();
                        UtilitarioBL.ObtenerDocumentoDetalle(DocumentoDetalle,
                            chkResultadosAnalisisEstacionA02,
                            hfResultadosAnalisisEstacionA02Comentario, null, null,
                            hfResultadosAnalisisEstacionA02, strRutaFisicaTemporal,
                            Type.GetType("System.Byte[]"));
                        #endregion

                        #region Resultados de Analisis Estación B 01
                        DocumentoDetalle = lstDetalles.Where(dd => dd.Campo.IdValor == "000503").Select(dd => dd).First();
                        UtilitarioBL.ObtenerDocumentoDetalle(DocumentoDetalle,
                            chkResultadosAnalisisEstacionB01,
                            hfResultadosAnalisisEstacionB01Comentario, null, null,
                            hfResultadosAnalisisEstacionB01, strRutaFisicaTemporal,
                            Type.GetType("System.Byte[]"));
                        #endregion

                        #region Resultados de Analisis Estación B 02
                        DocumentoDetalle = lstDetalles.Where(dd => dd.Campo.IdValor == "000504").Select(dd => dd).First();
                        UtilitarioBL.ObtenerDocumentoDetalle(DocumentoDetalle,
                            chkResultadosAnalisisEstacionB02,
                            hfResultadosAnalisisEstacionB02Comentario, null, null,
                            hfResultadosAnalisisEstacionB02, strRutaFisicaTemporal,
                            Type.GetType("System.Byte[]"));
                        #endregion
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                #region Resultados de Analisis Estación A 01
                UtilitarioBL.AsignarDocumentoDetalle(DocumentoDetalle,
                    Documento, "000501", chkResultadosAnalisisEstacionA01,
                    hfResultadosAnalisisEstacionA01Comentario, null, null,
                    hfResultadosAnalisisEstacionA01, strRutaFisicaTemporal,
                    Type.GetType("System.Byte[]"));
                #endregion
                ...
                #region Resultados de Analisis Estación A 02
                UtilitarioBL.AsignarDocumentoDetalle(DocumentoDetalle,
                    Documento, "000502", chkResultadosAnalisisEstacionA02,
                    hfResultadosAnalisisEstacionA02Comentario, null, null,
                    hfResultadosAnalisisEstacionA02, strRutaFisicaTemporal,
                    Type.GetType("System.Byte[]"));
                #endregion
                ...
                #region Resultados de Analisis Estación B 01
                UtilitarioBL.AsignarDocumentoDetalle(DocumentoDetalle,
                    Documento, "000503", chkResultadosAnalisisEstacionB01,
                    hfResultadosAnalisisEstacionB01Comentario, null, null,
                    hfResultadosAnalisisEstacionB01, strRutaFisicaTemporal,
                    Type.GetType("System.Byte[]"));
                #endregion
                ...
                #region Resultados de Analisis Estación B 02
                UtilitarioBL.AsignarDocumentoDetalle(DocumentoDetalle,
                    Documento, "000504", chkResultadosAnalisisEstacionB02,
                    hfResultadosAnalisisEstacionB02Comentario, null, null,
                    hfResultadosAnalisisEstacionB02, strRutaFisicaTemporal,
                    Type.GetType("System.Byte[]"));
                #endregion
