<%@ Page Title="" Language="C#" MasterPageFile="~/master/MasterPage.Master" AutoEventWireup="true" CodeBehind="DocumentoActaInstalacionPTPNoLicenciado.aspx.cs" Inherits="SNW.forms.DocumentoActaInstalacionPTP" %>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group-base input-group">
                                        <span class="input-group-addon"><span class="fa fa-file-image-o"></span></span>
                                        <div class="has-float-label">
                                            <div id="divResultadosAnalisisEstacionA01Ejemplo" class="form-control" style="height: 100%;">
                                                <img id="imgResultadosAnalisisEstacionA01Ejemplo" runat="server" alt="Resultados de Analisis Estación A 01 (Ejemplo)" style="width: 100%;" />
                                            </div>
                                            <label for="divResultadosAnalisisEstacionA01Ejemplo">Resultados de Analisis Estación A 01 (Ejemplo)</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group-base input-group">
                                        <div class="input-group-addon-base">
                                            <div class="checkbox checbox-switch switch-success">
                                                <label>
                                                    <asp:CheckBox ID="chkResultadosAnalisisEstacionA01" runat="server" />
                                                    <span title="Aprobado"></span>
                                                </label>
                                            </div>
                                        </div>
                                        <span class="input-group-addon"><span class="fa fa-comment" id="spResultadosAnalisisEstacionA01Comentario" data-placement="top" title="Comentario" data-content="" data-toggle="popover" data-trigger="click"></span></span>
                                        <div id="pocResultadosAnalisisEstacionA01Comentario" class="hide">
                                            <div class="row">
                                                <textarea id="txtResultadosAnalisisEstacionA01Comentario" cols="50" rows="6" maxlength="2000" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <input type="hidden" id="hfResultadosAnalisisEstacionA01Comentario" runat="server" />
                                        <div class="has-float-label">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group-base input-group">
                                        <span class="input-group-addon"><span class="fa fa-file-image-o"></span></span>
                                        <div class="has-float-label">
                                            <div id="divResultadosAnalisisEstacionA02Ejemplo" class="form-control" style="height: 100%;">
                                                <img id="imgResultadosAnalisisEstacionA02Ejemplo" runat="server" alt="Resultados de Analisis Estación A 02 (Ejemplo)" style="width: 100%;" />
                                            </div>
                                            <label for="divResultadosAnalisisEstacionA02Ejemplo">Resultados de Analisis Estación A 02 (Ejemplo)</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group-base input-group">
                                        <div class="input-group-addon-base">
                                            <div class="checkbox checbox-switch switch-success">
                                                <label>
                                                    <asp:CheckBox ID="chkResultadosAnalisisEstacionA02" runat="server" />
                                                    <span title="Aprobado"></span>
                                                </label>
                                            </div>
                                        </div>
                                        <span class="input-group-addon"><span class="fa fa-comment" id="spResultadosAnalisisEstacionA02Comentario" data-placement="top" title="Comentario" data-content="" data-toggle="popover" data-trigger="click"></span></span>
                                        <div id="pocResultadosAnalisisEstacionA02Comentario" class="hide">
                                            <div class="row">
                                                <textarea id="txtResultadosAnalisisEstacionA02Comentario" cols="50" rows="6" maxlength="2000" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <input type="hidden" id="hfResultadosAnalisisEstacionA02Comentario" runat="server" />
                                        <div class="has-float-label">
                                            <div id="divResultadosAnalisisEstacionA02" class="">
                                            </div>
                                            <label for="divResultadosAnalisisEstacionA02">Resultados de Analisis Estación A 02</label>
                                        </div>
                                    </div>
                                    <asp:HiddenField ID="hfResultadosAnalisisEstacionA02" runat="server" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group-base input-group">
                                        <span class="input-group-addon"><span class="fa fa-file-image-o"></span></span>
                                        <div class="has-float-label">
                                            <div id="divResultadosAnalisisEstacionB01Ejemplo" class="form-control" style="height: 100%;">
                                                <img id="imgResultadosAnalisisEstacionB01Ejemplo" runat="server" alt="Resultados de Analisis Estación B 01 (Ejemplo)" style="width: 100%;" />
                                            </div>
                                            <label for="divResultadosAnalisisEstacionB01Ejemplo">Resultados de Analisis Estación B 01 (Ejemplo)</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group-base input-group">
                                        <div class="input-group-addon-base">
                                            <div class="checkbox checbox-switch switch-success">
                                                <label>
                                                    <asp:CheckBox ID="chkResultadosAnalisisEstacionB01" runat="server" />
                                                    <span title="Aprobado"></span>
                                                </label>
                                            </div>
                                        </div>
                                        <span class="input-group-addon"><span class="fa fa-comment" id="spResultadosAnalisisEstacionB01Comentario" data-placement="top" title="Comentario" data-content="" data-toggle="popover" data-trigger="click"></span></span>
                                        <div id="pocResultadosAnalisisEstacionB01Comentario" class="hide">
                                            <div class="row">
                                                <textarea id="txtResultadosAnalisisEstacionB01Comentario" cols="50" rows="6" maxlength="2000" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <input type="hidden" id="hfResultadosAnalisisEstacionB01Comentario" runat="server" />
                                        <div class="has-float-label">
                                            <div id="divResultadosAnalisisEstacionB01" class="">
                                            </div>
                                            <label for="divResultadosAnalisisEstacionB01">Resultados de Analisis Estación B 01</label>
                                        </div>
                                    </div>
                                    <asp:HiddenField ID="hfResultadosAnalisisEstacionB01" runat="server" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group-base input-group">
                                        <span class="input-group-addon"><span class="fa fa-file-image-o"></span></span>
                                        <div class="has-float-label">
                                            <div id="divResultadosAnalisisEstacionB02Ejemplo" class="form-control" style="height: 100%;">
                                                <img id="imgResultadosAnalisisEstacionB02Ejemplo" runat="server" alt="Resultados de Analisis Estación B 02 (Ejemplo)" style="width: 100%;" />
                                            </div>
                                            <label for="divResultadosAnalisisEstacionB02Ejemplo">Resultados de Analisis Estación B 02 (Ejemplo)</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group-base input-group">
                                        <div class="input-group-addon-base">
                                            <div class="checkbox checbox-switch switch-success">
                                                <label>
                                                    <asp:CheckBox ID="chkResultadosAnalisisEstacionB02" runat="server" />
                                                    <span title="Aprobado"></span>
                                                </label>
                                            </div>
                                        </div>
                                        <span class="input-group-addon"><span class="fa fa-comment" id="spResultadosAnalisisEstacionB02Comentario" data-placement="top" title="Comentario" data-content="" data-toggle="popover" data-trigger="click"></span></span>
                                        <div id="pocResultadosAnalisisEstacionB02Comentario" class="hide">
                                            <div class="row">
                                                <textarea id="txtResultadosAnalisisEstacionB02Comentario" cols="50" rows="6" maxlength="2000" class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <input type="hidden" id="hfResultadosAnalisisEstacionB02Comentario" runat="server" />
                                        <div class="has-float-label">
                                            <div id="divResultadosAnalisisEstacionB02" class="">
                                            </div>
                                            <label for="divResultadosAnalisisEstacionB02">Resultados de Analisis Estación B 02</label>
                                        </div>
                                    </div>
                                    <asp:HiddenField ID="hfResultadosAnalisisEstacionB02" runat="server" />
                                </div>
                            </div>
                        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphPie" runat="server">
    <script src="../js/forms/DocumentoActaInstalacionPTPNoLicenciado.js"></script>
</asp:Content>
