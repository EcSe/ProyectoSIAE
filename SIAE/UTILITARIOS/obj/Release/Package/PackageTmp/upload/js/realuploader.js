...
function (Constants, Utils, SimpleRunner, _, FileMd5, ExifReader, ImageScale) {
    ...
    FileObject.prototype = {
        ...
        bindFilePreview: function () {
            //console.log("bindFilePreview 01");
            var me          = this;
    ...
    RealUploader.prototype = {
        ...
        addFiles: function (files) {
            ...
            for (var i = 0; i < files.length; i++) {
                ...
                var err = this.checkFile(file.name, file.size, file.extension, file);
         ...
         */
        checkFile: function (name, size, ext, file) {
