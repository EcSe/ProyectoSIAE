    ...
    public class ReporteDocumentosBL
    {
        ...
        public void PruebaServicioDITGPMP(String IdNodo, String IdTarea, String valorCadena1, String rutaPlantilla)
        {
            ...
            try
            {
                ...
                ExcelToolsBL.UpdateCell(excelGenerado, "Pruebas de Servicios", TIEMPO_PRUEBA, 34, "F");
                ExcelToolsBL.UpdateCell(excelGenerado, "Pruebas de Servicios", RETARDO_MIN, 35, "F");
                ExcelToolsBL.UpdateCell(excelGenerado, "Pruebas de Servicios", RETARDO_MAXIMO, 36, "F");
                ExcelToolsBL.UpdateCell(excelGenerado, "Pruebas de Servicios", RETARDO_PROMEDIO, 37, "F");
                ExcelToolsBL.UpdateCell(excelGenerado, "Pruebas de Servicios", JILTER_PROMEDIO, 38, "F");
                ExcelToolsBL.UpdateCell(excelGenerado, "Pruebas de Servicios", DESV_ESTANDAR_RETARDO, 39, "F");
                ExcelToolsBL.UpdateCell(excelGenerado, "Pruebas de Servicios", BYTES_RECIBIDOS, 40, "F");
                ExcelToolsBL.UpdateCell(excelGenerado, "Pruebas de Servicios", THROUGHPUT_PROM, 41, "F");
                ExcelToolsBL.UpdateCell(excelGenerado, "Pruebas de Servicios", DESCARTE_PAQUETES, 42, "F");

                ExcelToolsBL.AddImageDocument(false, excelGenerado, "Selección de Frecuencia", FECHA_HORA_ROUTERm, "", 7, 2, 534, 234);
                ExcelToolsBL.AddImageDocument(false, excelGenerado, "Selección de Frecuencia", DIRECCIONES_MACm, "", 126, 2, 534, 234);
                ExcelToolsBL.AddImageDocument(false, excelGenerado, "Selección de Frecuencia", RESULTADO_PRUEBA_DITGm, "", 149, 2, 534, 234);
                ExcelToolsBL.AddImageDocument(false, excelGenerado, "Selección de Frecuencia", PING_CPE_DESDE_NODO_Am, "", 48, 2, 534, 234);
                ExcelToolsBL.AddImageDocument(false, excelGenerado, "Selección de Frecuencia", PING_ALL_USERS_01m, "", 98, 2, 177, 141);
                ExcelToolsBL.AddImageDocument(false, excelGenerado, "Selección de Frecuencia", PING_ALL_USERS_02m, "", 98, 5, 177, 141);
                ExcelToolsBL.AddImageDocument(false, excelGenerado, "Selección de Frecuencia", PING_ALL_USERS_03m, "", 98, 8, 177, 141);
                ExcelToolsBL.AddImageDocument(false, excelGenerado, "Selección de Frecuencia", PING_ALL_USERS_04m, "", 110, 2, 177, 141);
                ExcelToolsBL.AddImageDocument(false, excelGenerado, "Selección de Frecuencia", PING_ALL_USERS_05m, "", 110, 5, 177, 141);
                ExcelToolsBL.AddImageDocument(false, excelGenerado, "Selección de Frecuencia", PING_ALL_USERS_06m, "", 110, 8, 177, 141);
        ...
        public void Anexo2InventarioPMP(String IdNodo, String IdTarea, String valorCadena1, String rutaPlantilla)
        {
            ...
            try
            {
                ...
                ExcelToolsBL.UpdateCell(excelGenerado, "11 Serie logística", COD_NODO, 11, "A");
                ExcelToolsBL.AddImageDocument(false, excelGenerado, "11 Serie logística", ANTENAm, "", 14, 3, 489, 368);
                ExcelToolsBL.AddImageDocument(false, excelGenerado, "11 Serie logística", ARRESTOR_LANm, "", 22, 3, 489, 368);
                ExcelToolsBL.AddImageDocument(false, excelGenerado, "11 Serie logística", ODUsm, "", 29, 3, 250, 368);
                ExcelToolsBL.AddImageDocument(false, excelGenerado, "11 Serie logística", POEm, "", 36, 3, 489, 368);
        ...
        public void InstalacionPozoTierra(String IdNodo, String IdTarea, String valorCadena1, String rutaPlantilla)
        {
            ...
            try
            {
                ...
                ExcelToolsBL.UpdateCell(excelGenerado, "POZO A TIERRA 10 Ohm", INSTITUCION, 7, "G");
                ExcelToolsBL.UpdateCell(excelGenerado, "POZO A TIERRA 10 Ohm", CODIGO_IIBB, 7, "O");
                ExcelToolsBL.UpdateCell(excelGenerado, "POZO A TIERRA 10 Ohm", NOMBRE_IIBB, 8, "K");
        ...
        public void ActaSeguridadDistribucion(String IdNodo, String IdTarea, String valorCadena1, String rutaPlantilla)
        {
            ...
            try
            {
                ...
                ExcelToolsBL.UpdateCell(excelGenerado, "Carátula", NOMBRE_NODO, 15, "D");
                ExcelToolsBL.UpdateCell(excelGenerado, "Carátula", NOMBRE_NODO, 17, "D");
