IF OBJECT_ID('USP_R_EQUIPAMIENTOS_PTP_NO_LIC_B') IS NOT NULL
DROP PROC USP_R_EQUIPAMIENTOS_PTP_NO_LIC_B
GO--
CREATE PROC USP_R_EQUIPAMIENTOS_PTP_NO_LIC_B
@CH_ID_TAREA CHAR(7)
AS
	BEGIN
		...
		WHERE DE.CH_ID_TAREA= @CH_ID_TAREA AND DE.CH_ID_DOCUMENTO = '000009'
	END
GO