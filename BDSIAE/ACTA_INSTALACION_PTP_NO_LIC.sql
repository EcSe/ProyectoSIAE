IF OBJECT_ID('USP_R_ACTA_INSTALACION_PTP_NO_LIC') IS NOT NULL
DROP PROC USP_R_ACTA_INSTALACION_PTP_NO_LIC
GO
CREATE PROC USP_R_ACTA_INSTALACION_PTP_NO_LIC
@CH_ID_TAREA CHAR(7)
AS
	...
	BEGIN
		SELECT(SELECT DT_VALOR_FECHA
				...
				WHERE CH_ID_DOCUMENTO='000009' AND
				...
				WHERE CH_ID_DOCUMENTO='000009' AND
				CH_ID_TAREA = @CH_ID_TAREA AND
				CH_ID_CAMPO = '000128')AS SERIE_CMM4_ESTAC_A,

				(SELECT ISNULL(VB_VALOR_BINARIO,@IMAGEN)
				FROM DOCUMENTO_DET DD
				WHERE CH_ID_DOCUMENTO='000009' AND
				CH_ID_TAREA = @CH_ID_TAREA AND
				CH_ID_CAMPO = '000129')AS SERIE_UGPS_ESTAC_A,

				(SELECT ISNULL(VB_VALOR_BINARIO,@IMAGEN)
				FROM DOCUMENTO_DET DD
				WHERE CH_ID_DOCUMENTO='000009' AND
				CH_ID_TAREA = @CH_ID_TAREA AND
				CH_ID_CAMPO = '000130')AS SERIE_CONVERSOR_ESTAC_A,
				...
				WHERE CH_ID_DOCUMENTO='000009' AND
				CH_ID_TAREA = @CH_ID_TAREA AND
				CH_ID_CAMPO = '000134')AS SERIE_CMM4_ESTAC_B,

				(SELECT ISNULL(VB_VALOR_BINARIO,@IMAGEN)
				FROM DOCUMENTO_DET DD
				WHERE CH_ID_DOCUMENTO='000009' AND
				CH_ID_TAREA = @CH_ID_TAREA AND
				CH_ID_CAMPO = '000135')AS SERIE_UGPS_ESTAC_B,

				(SELECT ISNULL(VB_VALOR_BINARIO,@IMAGEN)
				FROM DOCUMENTO_DET DD
				WHERE CH_ID_DOCUMENTO='000009' AND
				CH_ID_TAREA = @CH_ID_TAREA AND
				CH_ID_CAMPO = '000136')AS SERIE_CONVERSOR_ESTAC_B,
...
-------------------------------------------------------------------------------
	...
	--VALORES FUERA DEL FORMULARIO 
			...
			AND T.CH_ID_NODO_B = P.CH_ID_NODO_B)
			...
			AND P.CH_ID_NODO_B = T.CH_ID_NODO_B)
			...
			WHERE T.CH_ID_TAREA = @CH_ID_TAREA) AS IP_NODO_A,

			(SELECT IPP.VC_IP_NODO_B
			FROM TAREA T INNER JOIN IP_PLANNING_PTP_DET IPP
			ON T.CH_ID_NODO_B = IPP.CH_ID_NODO_B
			WHERE T.CH_ID_TAREA = @CH_ID_TAREA) AS IP_NODO_B,

			(SELECT VC_DEF_GATEWAY
			FROM TAREA T INNER JOIN IP_PLANNING_PTP IPP
			ON T.VC_ID_NODO_IIBB_A = IPP.CH_ID_NODO_A
			WHERE T.CH_ID_TAREA =@CH_ID_TAREA) AS DEFAULT_GATE_A_B,
