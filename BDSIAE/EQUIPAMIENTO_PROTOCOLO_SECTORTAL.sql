IF OBJECT_ID('USP_R_EQUIPAMIENTOS_SECTORIAL') IS NOT NULL
DROP PROC USP_R_EQUIPAMIENTOS_SECTORIAL
GO--
CREATE PROC USP_R_EQUIPAMIENTOS_SECTORIAL
@CH_ID_TAREA CHAR(7)
AS
	BEGIN
		...
		WHERE DE.CH_ID_TAREA= @CH_ID_TAREA AND DE.CH_ID_DOCUMENTO = '000001'
	END
GO
