IF OBJECT_ID('USP_R_INSTALACION_POZO_TIERRA_B') IS NOT NULL
DROP PROC USP_R_INSTALACION_POZO_TIERRA_B
GO
CREATE PROC USP_R_INSTALACION_POZO_TIERRA_B
@CH_ID_TAREA CHAR(7)
AS
	BEGIN 
