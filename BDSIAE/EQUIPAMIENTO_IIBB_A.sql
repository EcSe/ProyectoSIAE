IF OBJECT_ID('USP_R_EQUIPAMIENTOS_IIBB_A') IS NOT NULL
DROP PROC USP_R_EQUIPAMIENTOS_IIBB_A
GO--
CREATE PROC USP_R_EQUIPAMIENTOS_IIBB_A
@CH_ID_TAREA CHAR(7)
AS
	BEGIN
		...
		WHERE DE.CH_ID_TAREA= @CH_ID_TAREA AND DE.CH_ID_DOCUMENTO = '000015'
	END
GO
